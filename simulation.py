...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        print("Vehicle created in lane", lane, "class:", vehicleClass, "direction:", direction, "will turn:", will_turn)
        # Your existing code here...
...
def block_add():
    ...
    hash_value = hash_object.hexdigest()  # Getting the hexadecimal representation of the hash
    return hash_value
def initialize():
